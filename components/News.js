...
export default function Third() {
  const [news, setNews] = useState([
  {
    ...
    content: "Even amongst our highest and most frequent spenders, we see a sudden increase in use of Tag Spends, Save in Pots, and No-Penalty SIP for investments said Jupiter, a 100% digital banking and investing app. Users are tracking expenses with Custom Tags and Categories and are prioritizing saving and investing more towards their goals, more than ever before, added Jupiter.",
    time: "",
    upvote: 21,
    tokenId: 2,
  },
  {
    address: "0xdd3ddadsadd",
    title: "Incorrect to suggest otherwise: TCS on reports of no pay hike for experienced staff",
    content: "Tata Consultancy Services (TCS) responded after media reports claimed that the IT major has revised its anniversary appraisal policy and will not be rolling out hikes to employees who have completed one year. TCS said, It's incorrect to suggest otherwise. All experienced hires will be given an increase as part of the annual salary appraisal that follows their one-year anniversary.",
    time: "",
    upvote: 21,
    tokenId: 2,
  },
